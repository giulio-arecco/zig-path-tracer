...
pub fn main(init: std.process.Init) !void {
    ...
    const parallelRayTracer = ParallelRayTracer {
        .settings = render_settings,
        .io = threaded.io()
    };
    ...
    raytracer.render(scene, memory_map.memory[PPM_HEADER_LEN..]);
    ...
    try parallelRayTracer.render(scene, memory_map.memory[PPM_HEADER_LEN..]);
